...
* **Minimap Integration:** Features a Stop Sign icon on the minimap for quick window toggling, supporting full circular dragging.
...
* **Left-Click** (Stop Sign icon): Opens or closes the manager window.
* **Left-Mouse Drag** (Stop Sign icon): Move your mouse to reposition the gear around the minimap.
